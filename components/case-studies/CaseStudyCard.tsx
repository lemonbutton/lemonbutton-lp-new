...
export const CaseStudyCard: React.FC<CaseStudyCardProps> = ({
  ...
  return (
    <div className="w-full h-full group bg-lemon relative text-white hover:text-black transition-all duration-300 font-JetBrainsMono  group-hover:border-t-zinc-700 hover:cursor-pointer">
